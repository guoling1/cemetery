...
$.ajax({
    ...
    success: function (data) {
        ...
        $(data.data).each(function (ind,item) {
            ...
            aLi+='<div class="swiper-slide"><a href="public-new-detail1.html?ContentId='+item.ContentId+'&ParentId=d9826e7d-cedb-4a24-a8bf-e63ecdb30e25&id=43c18d0e-0772-451a-912d-d36bcacace63"><img src="'+GLOBEL_IP+''+item.ImgUrl+'" alt=""><div class="title">'+item.Title+'</div> </a></div>'
        })
